class Buby
  ...
  module ContextMenuInvocation
    ...
    def self.implant(invocation)
      unless invocation.implanted?
        pp [:implanting, invocation, invocation.class, invocation.java_class.__persistent__] if $DEBUG
        # Leave __persistent__ off for now might need it later
        # invocation.java_class.__persistent__ = true
        invocation.class.class_eval do
           ...
           include Burp::ContextMenuInvocation
